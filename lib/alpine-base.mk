...
var/alpine-base : var/netboot/initramfs-virt var/netboot/modloop-virt var/netboot/vmlinuz-virt var/id_ed25519 var/daiker 
	...
	var/daiker build -T 22-2220 -Q '-kernel var/netboot/vmlinuz-virt -initrd var/netboot/initramfs-virt -append alpine_repo=https://dl-cdn.alpinelinux.org/alpine/edge/main	modloop=http://10.0.2.2:8000/netboot/modloop-virt	ssh_key=http://10.0.2.2:8000/id_ed25519.pub' $$PWD/$@.qcow2 &
